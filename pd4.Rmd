...
Trabajaremos con la base de datos `latinarfinal.sav`. Esta base de datos
es la misma que se usó en la P2, con la diferencia de que se han
eliminado aquellos datos vacíos en la variable creada `inmigracion`.\
