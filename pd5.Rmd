...
```{r}
setwd("C:/Users/Lala/Documents/GitHub/Estadistica1_sociologia_2025_2.github.io")
```
...
fpc = ~fpc
fpc es la corrección por población finita (finite population correction).
Indica el tamaño de la población total de la cual se extrajo la muestra.
En el dataset apisrs, esa variable (fpc) tiene el valor de𝑁, la población total, asignado a cada observación.

Esto le dice a R: “Oye, la muestra no es con reemplazo y corresponde a una población finita de tamaño N, así que ajusta la varianza con la corrección FPC”.
...
Esto representa el tamaño de la población total (N) de donde salió la muestra.
Se usa como corrección por población finita (finite population correction) al definir el diseño muestral.

2. pw = 994494/994
Aquí se calcula un peso muestral (pw).

Significa que cada observación de la muestra representa a ~1000 unidades de la población.
...
Instrucción de mutate para mantener todas las variables originales de mas4, además de las nuevas (fpc, pw, n).
